        ...
        <section class="well-xl">
          <div class="container">
              <div class="row row-60">
                  <div class="col-lg-6">
                      <h2 class="line-3">How to rent</h2>
                      <p class="text-default-2 inset-1 letter-spacing-1">We'll help you find your new
                          home</p>
                                ...
                                <ol class="marked-list">
                                  ...
                                  <li>The Rental Agent will forward your application to
                									...
                									<li>If your application is declined your Last Month's Rent
                										Deposit will be fully refunded.</li>
                                </ol>
                              </p>
                          </div>
                      </div>
                        ...
                        <div class="col-lg-12 contact_list" >
                          <dd>
                              <div class="box">
                                  ...
                                  <div class="cnt">
                                      <a href="docs/Rental_Application.pdf">Download an application</a>
                                  </div>
                              </div>
                          </dd>
                  ...
                  <div class="col-lg-6">
                      <img width="470" height="170" alt="" src="images/photo_how_to_rent.jpg">
                  </div>
              </div>
          </div>
          </div>
